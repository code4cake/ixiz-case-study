...
export default function EventList({ onOpenEvent }: EventListProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-5 pb-10 pt-8 md:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 md:max-w-xs">
          <button
            className="flex w-full items-center justify-center gap-2 rounded-md bg-blue-600 px-4 py-4 text-base font-medium text-white hover:bg-blue-700"
            onClick={() => {
              showToast({
